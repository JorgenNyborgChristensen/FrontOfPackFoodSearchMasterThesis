...
function searchRecipe(query) {
  const url = `http://localhost:3000/search1/${query}`;
  fetch(url)
               ...
               <div class="recipe-content-box">
                  ...
                  <div class="recipe-card-actions">
                    ...
                    ><a class="select-button button button--primary" id="${
                      recipe.recipe_id
                    }" href="../condition_1/choice_survey.html" onclick="sessionStoreAppend(this.id)"
                      >Select Recipe</a
                    >
                  </div>
                  </div>
...
function postDemographicsSurvey() {
  const data = {
    user_id,
    gender,
    age,
...
function postRecipe() {
  let survey = sessionStorage.survey;
  let choice1 = sessionStorage.choice1;
  let survey1 = sessionStorage.survey1;
  let choice2 = sessionStorage.choice2;
  let survey2 = sessionStorage.survey2;
  const data = {};
  try {
    const res = fetch(`http://localhost:3000`, {
      header: {
